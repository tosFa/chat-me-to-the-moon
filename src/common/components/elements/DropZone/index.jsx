...
class Dropzone extends React.Component {
  constructor(props, context) {
    ...
    this.onFileDialogCancel = ::this.onFileDialogCancel;
    this.fileAccepted = ::this.fileAccepted;
  ...
  onDrop(e) {
    ...
    if (this.props.onDrop) {
      this.props.onDrop(acceptedFiles, rejectedFiles, e);
    }

    if (rejectedFiles.length > 0) {
      if (this.props.onDropRejected) {
        this.props.onDropRejected(rejectedFiles, e);
      }
    } else if (acceptedFiles.length > 0) {
      if (this.props.onDropAccepted) {
        this.props.onDropAccepted(acceptedFiles, e);
      }
    }
    this.isFileDialogActive = false;
  }
